...
export const OPENCLAW_ENABLED = env.OPENCLAW_ENABLED;
export const OPENCLAW_GATEWAY_URL = env.OPENCLAW_GATEWAY_URL;
export const OPENCLAW_API_KEY = env.OPENCLAW_API_KEY;
export const OPENCLAW_DEFAULT_MODEL = env.OPENCLAW_DEFAULT_MODEL;
export const OPENCLAW_TRIGGER_PREFIX = env.OPENCLAW_TRIGGER_PREFIX;

// Wallet Authentication settings
export const WALLET_AUTH_ENABLED = env.WALLET_AUTH_ENABLED;
export const WALLET_CHAIN_ID = env.WALLET_CHAIN_ID;
export const WALLET_PROJECT_ID = env.WALLET_PROJECT_ID;

// Invite System settings
export const INVITE_ENABLED = env.INVITE_ENABLED;
