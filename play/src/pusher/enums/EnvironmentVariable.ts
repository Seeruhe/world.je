...
export const OPENCLAW_ENABLED: boolean = env.OPENCLAW_ENABLED;
export const OPENCLAW_GATEWAY_URL: string = env.OPENCLAW_GATEWAY_URL || "ws://localhost:18789";
export const OPENCLAW_API_KEY: string | undefined = env.OPENCLAW_API_KEY;
export const OPENCLAW_DEFAULT_MODEL: string = env.OPENCLAW_DEFAULT_MODEL || "gpt-4";
export const OPENCLAW_TRIGGER_PREFIX: string = env.OPENCLAW_TRIGGER_PREFIX || "/ai";
...
export const WALLET_AUTH_ENABLED: boolean = env.WALLET_AUTH_ENABLED;
export const WALLET_CHAIN_ID = env.WALLET_CHAIN_ID;
export const WALLET_PROJECT_ID: string | undefined = env.WALLET_PROJECT_ID;

// Invite System Configuration
export const INVITE_ENABLED: boolean = env.INVITE_ENABLED;
export const INVITE_REWARD_POINTS = env.INVITE_REWARD_POINTS;
export const INVITE_CODE_LENGTH = env.INVITE_CODE_LENGTH;

// NFT Badge Configuration
export const NFT_CONTRACT_ADDRESS: string | undefined = env.NFT_CONTRACT_ADDRESS;
export const NFT_CHAIN_ID = env.NFT_CHAIN_ID;
...
export const FRONT_ENVIRONMENT_VARIABLES: FrontConfigurationInterface = {
    ...
    OPENCLAW_GATEWAY_URL: env.OPENCLAW_GATEWAY_URL || "ws://localhost:18789",
    OPENCLAW_API_KEY: env.OPENCLAW_API_KEY,
    OPENCLAW_DEFAULT_MODEL: env.OPENCLAW_DEFAULT_MODEL || "gpt-4",
    OPENCLAW_TRIGGER_PREFIX: env.OPENCLAW_TRIGGER_PREFIX || "/ai",
    // Wallet Authentication settings
    WALLET_AUTH_ENABLED: env.WALLET_AUTH_ENABLED,
    WALLET_CHAIN_ID: env.WALLET_CHAIN_ID,
    WALLET_PROJECT_ID: env.WALLET_PROJECT_ID,
    // Invite System settings
    INVITE_ENABLED: env.INVITE_ENABLED,
    INVITE_REWARD_POINTS: env.INVITE_REWARD_POINTS,
};
