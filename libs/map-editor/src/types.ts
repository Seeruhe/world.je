...
export const AINPCPropertyData = PropertyBase.extend({
    type: z.literal("aiNpcPropertyData"),
    name: z.string(),
    personality: z.string().optional(),
    systemPrompt: z.string().optional(),
    model: z.string().optional(),
    triggerDistance: z.number().optional().default(64),
    triggerMessage: z.string().optional(),
    greetingMessage: z.string().optional(),
    conversationStartPrompt: z.string().optional(),
});
